...
DEFAULT_PERMISSIONS: list[dict[str, str]] = [
    ...
    {"code": "payroll.draft", "name": "Create & Edit Payroll Drafts", "module": "finance"},
    {"code": "payroll.submit", "name": "Submit Payroll for Review", "module": "finance"},
    {"code": "payroll.approve", "name": "Approve/Reject Payroll", "module": "finance"},
    {"code": "payroll.export", "name": "Export Payroll Bank File", "module": "finance"},
    {"code": "payroll.import", "name": "Upload Payment Status", "module": "finance"},
    {"code": "payroll.finalize", "name": "Finalize Payroll & Generate Payslips", "module": "finance"},
    ...
    {"code": "recruitment.view", "name": "View Candidates", "module": "recruitment"},
    {"code": "recruitment.manage", "name": "Manage Candidates & Hiring", "module": "recruitment"},
    # Settings / Admin
